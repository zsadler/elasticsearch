...
Elasticsearch can easily index massive amounts of data and return results faster with less resource consumption when compared to then other search technologies (e.g. conventional SQL database search).
